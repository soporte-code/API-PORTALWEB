...
print('=== PROBAR ENDPOINT MAPEOS CORREGIDO ===')
try:
    # Login
            ...
            try:
                ...
                if cuarteles_response.status_code == 200:
                    ...
                    if cuarteles:
                        ...
                        print(f'\n--- PROBAR MAPEOS CON CUARTEL: {cuartel_nombre} (ID: {cuartel_id}) ---')
                        ...
                        try:
                            ...
                            if mapeos_response.status_code == 200:
                                ...
                                if mapeos_result["data"]["mapeos"]:
                                    mapeo = mapeos_result["data"]["mapeos"][0]
                                    print(f'  Primer mapeo:')
                                    print(f'    ID: {mapeo["id"]}')
...
print('\n=== RESUMEN ===')
print('Prueba del endpoint mapeos completada.')
print('El endpoint ahora debe funcionar sin errores de columnas inexistentes.')
